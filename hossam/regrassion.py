...
def my_linear_regrassion(x_train: DataFrame, y_train: Series, x_test: DataFrame = None, y_test: Series = None, cv: int = 5, learning_curve: bool = True, report=False, plot: bool = False, resid_test=False, degree: int = 1, figsize=(10, 5), dpi: int = 100, sort: str = None) -> LinearRegression:
...
def my_regrassion_report(estimator: LinearRegression, x: DataFrame = None, y: Series = None, sort: str = None, plot: bool = False, degree: int = 1, figsize: tuple = (10, 5), dpi: int = 100) -> None:
    """선형회귀분석 결과를 보고한다.
...
def my_resid_test(x: DataFrame, y: Series, y_pred: Series, figsize: tuple=(10, 5), dpi: int=200) -> None:
    """잔차의 가정을 확인한다.
