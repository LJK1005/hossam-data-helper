...
from .plot import my_learing_curve, my_confusion_matrix, my_roc_curve, my_pr_curve, my_roc_pr_curve

def my_logistic_classification(x_train: DataFrame, y_train: Series, x_test: DataFrame = None, y_test: Series = None, cv: int = 5, roc_curve: bool = False, pr_curve: bool = False, learning_curve=True, report: bool = True, figsize=(10, 5), dpi: int = 100, sort: str = None, **params: list) -> LogisticRegression:
    ...
    if x_test is not None and y_test is not None:
        my_classification_result(estimator, x_train=x_train, y_train=y_train, x_test=x_test, y_test=y_test, roc_curve=roc_curve, pr_curve=pr_curve, learning_curve=learning_curve, cv=cv, figsize=figsize, dpi=dpi)
    else:
        my_classification_result(estimator, x_train=x_train, y_train=y_train, roc_curve=roc_curve, pr_curve=pr_curve, learning_curve=learning_curve, cv=cv, figsize=figsize, dpi=dpi)
